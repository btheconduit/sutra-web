...
export function SearchSidebar({
  ...
  return (
    <div className="flex h-full w-72 shrink-0 flex-col border-r border-zinc-200/40 bg-white/40 backdrop-blur-2xl backdrop-saturate-150 dark:border-zinc-700/30 dark:bg-zinc-950/30">
